...
import kotlinx.android.synthetic.main.activity_diary.img_diary_emoji
import kotlinx.android.synthetic.main.activity_diary.img_diary_highlighter
import kotlinx.android.synthetic.main.activity_diary.layout_diary_date
import kotlinx.android.synthetic.main.activity_diary.text_diary_day
import kotlinx.android.synthetic.main.activity_diary.text_diary_day_of_the_week
import kotlinx.android.synthetic.main.activity_diary.text_diary_title
...
//
//                editDiary = AppDatabase.getInstance(this@DiaryEditActivity)!!.diaryDao().selectById(dbID)
//
//
//                Log.e("test", "Size  ${KUtil.calendarList.size}")
//
//
        ...
        layout_top_check.setOnClickListener {
         ...
         //   diaryDataData.id = dbID
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                AppDatabase.getInstance(this@DiaryEditActivity)!!.diaryDao().insert(diaryDataData)
...
//            wheel_dialog_calendar.data =  KUtil.calendarList
    ...
    fun init() {
        ...
        edit_diary_message.setSelection(calendarData!!.diaryEntity.message.length)
    }
    ...
    private fun insertDiary(diaryData: DiaryData) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            AppDatabase.getInstance(this@DiaryEditActivity)!!.diaryDao().insert(diaryData)
        }
    }
    ...
    private fun setHighLighter() {
        ...
        text_diary_title.viewTreeObserver.addOnGlobalLayoutListener(object : OnGlobalLayoutListener {
            override fun onGlobalLayout() {
                ...
                val params = RelativeLayout.LayoutParams(width, KUtil.dpToPx(this@DiaryEditActivity, 30f).toInt())
